...
abstract final class CoresDoAplicativo {
  static const Color fundoPrincipal = Color(0xFF0A0B0D);
  static const Color fundoExterno = Color(0xFF040506);
  static const Color fundoSecundario = Color(0xFF101114);
  ...
  static const Color ambar = Color(0xFFF2B84B);
  static const Color coral = Color(0xFFFF6B57);
  static const Color azulSuave = Color(0xFF8AB4F8);
  static const Color roxoSuave = Color(0xFFB6A7FF);
  static const Color perigo = Color(0xFFEF5D50);
