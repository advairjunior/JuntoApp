...
public static class ValidadorDeAudio
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new ExcecaoDeAplicacaoException("Não foi possível validar o conteúdo do áudio.");
        }
        ...
        {
            "audio/mp4" => EhIsoBaseMediaValido(conteudo.Length, cabecalho),
            "audio/webm" => EhWebmValido(conteudo.Length, cabecalho),
            _ => false
        };
        ...
        if (!conteudoEhValido)
        {
            throw new ExcecaoDeAplicacaoException(
                "O conteúdo do arquivo não corresponde a um áudio MP4 ou WEBM válido.");
        }
    }
